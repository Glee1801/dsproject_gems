...
dataset <- read_csv("Data.csv") %>% 
  mutate(AgeCat = cut(Age, breaks = c(0,13,18,23,33,45,60), labels = c("7-13", "13-18", "18-23", "23-33", "33-45", "45-60"))) %>%
...
sleepmedia_anim <- dataset %>% 
  ...
  ggplot(aes(x = Sleep, 
             ...
             group = AgeCat)) +
  geom_jitter() +
  labs(y = "Hours of Social Media Use", 
       x = "Hours of Sleep", 
